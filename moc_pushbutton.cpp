...
QT_MOC_LITERAL(1, 11, 5), // "solid"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 3) // "dot"

    },
    "PushButton\0solid\0\0dot"
};
...
void PushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PushButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PushButton::solid)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PushButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PushButton::dot)) {
                *result = 1;
                return;
            }
        }
